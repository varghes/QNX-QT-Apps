...
connect(newGameAction, SIGNAL(triggered()), this, SLOT(MainWindow::newGame()));
    ...
    connect(pauseAction, SIGNAL(triggered()), game, SLOT(GameController::pause()));
	...
	//connect(resumeAction, &QAction::triggered, game, &GameController::resume);
	 connect(resumeAction, SIGNAL(triggered()), game, SLOT(GameController::resume()));
    ...
    connect(gameHelpAction, SIGNAL(triggered()), this, SLOT(MainWindow::gameHelp()));
	
	aboutAction = new QAction(tr("&About"), this);
	aboutAction->setStatusTip(tr("Show the application's about box"));
	//connect(aboutAction, &QAction::triggered, this, &MainWindow::about);
	connect(aboutAction, SIGNAL(triggered()), this, SLOT(MainWindow::about()));

	aboutQtAction = new QAction(tr("About &Qt"), this);
	aboutQtAction->setStatusTip(tr("Show the Qt library's About box"));
	//connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
	connect(aboutQtAction, SIGNAL(triggered()), qApp, SLOT(QApplication::aboutQt()));
}
